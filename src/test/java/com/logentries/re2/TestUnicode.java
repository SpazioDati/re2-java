...
public class TestUnicode {
    ...
    public void testReplace ( ) {
        Map<String, String> cases = new HashMap<String, String>() {{
            put("", "");
            put("\\b", "(?P<_ignore_0>" + RE2.BOUNDARY_REPLACE + ")");
            put("\\w", RE2.WORD_REPLACE);
            put("\\W", RE2.NON_WORD_REPLACE);
            put("\\b\\b", "(?P<_ignore_0>" + RE2.BOUNDARY_REPLACE + ")(?P<_ignore_1>" + RE2.BOUNDARY_REPLACE + ")");
            put("\\w{3}\\b", RE2.WORD_REPLACE + "{3}(?P<_ignore_0>" + RE2.BOUNDARY_REPLACE + ")");
        }};
    ...
    public static class TestWordBoundaries {
        ...
        public void testIgnoreMiddle() throws Exception {
            RE2 regex = new RE2("(\\b\\w+\\b)asd(\\b\\w+\\b)", Options.UNICODE_WORD);
